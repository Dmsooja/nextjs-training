        ...
        <>
          <div className="relative z-10 bg-white shadow">
            <div className="max-w-7xl mx-auto flex px-4 py-6 sm:px-6 lg:px-8">
              ...
              >
                <span><RichText render={slice.primary.title} /></span>
                <ChevronDownIcon
                  className={classNames(
              ...
              <div className="relative max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2">
                ...
                >
                  ...
                  {slice?.items?.map((item, idx) => {
                    return (
                      <div key={idx}>
                        <div className="text-sm font-medium tracking-wide text-gray-500 uppercase"><RichText render={item.subMenuTitle} /></div>
