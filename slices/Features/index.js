    ...
    <div className="py-12 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="lg:text-center">
          <span className="text-base text-indigo-600 font-semibold tracking-wide uppercase"><RichText render={slice.primary.title} /></span>
            ...
            {slice?.items?.map((item, i) => (
              <div key={i} className="relative">
                <dt>
                  ...
                  <span className="ml-16 text-lg leading-6 font-medium text-gray-900"><RichText render={item.descriptionTitle} /></span>
                </dt>
